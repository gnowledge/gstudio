...
factory_gsystem_types = [{'name':'Twist','meta_type':'factory_types'}, {'name':'Reply','meta_type':'factory_types'}, {'name':'Author','meta_type':'factory_types'}, {'name':'Shelf','meta_type':'factory_types'}, {'name':'QuizItem','meta_type':'factory_types'}, {'name':'Pandora_video','meta_type':'factory_types'},{'name':'NUSSD Course','meta_type':'factory_types'},{'name':'task_update_history','meta_type':'factory_types'},{'name':'Topic','meta_type':'factory_types'},{'name':'Theme','meta_type':'factory_types'},{'name':'theme_item','meta_type':'factory_types'}]
...
factory_attribute_types = [{'quiz_type':{'gsystem_names_list':['QuizItem'], 
                           ...
                           {'version':{'gsystem_names_list':['Module'], 
                                       'data_type':'u""', 
                                       'meta_type':'factory_types'}},
                           {'apps_list':{'gsystem_names_list':['Group'],
                                         'data_type':'list',
                                         'meta_type':'factory_types'}},
                           ...
                           {'Estimated_time':{'gsystem_names_list':['Task'], 
                                              'data_type':'float',
                                              'meta_type':'factory_types'}},
                           {'age_range':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                         'data_type':'basestring',
                                         'meta_type':'factory_types'}},
                           {'audience':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                        'data_type':'basestring',
                                        'meta_type':'factory_types'}},
                           {'timerequired':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                            'data_type':'basestring',
                                            'meta_type':'factory_types'}},
                           {'interactivitytype':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                                 'data_type':'basestring',
                                                 'meta_type':'factory_types'}},
                           {'basedonurl':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                          'data_type':'basestring',
                                          'meta_type':'factory_types'}},
                           {'educationaluse':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                              'data_type':'basestring',
                                              'meta_type':'factory_types'}},
                           {'textcomplexity':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                              'data_type':'basestring',
                                              'meta_type':'factory_types'}},
                           {'readinglevel':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                            'data_type':'basestring',
                                            'meta_type':'factory_types'}},
                           {'educationalsubject':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                                  'data_type':'basestring',
                                                  'meta_type':'factory_types'}},
                           {'educationallevel':{'gsystem_names_list':['Quiz','Topic','File','Page'],
                                                'data_type':'basestring',
                                                'meta_type':'factory_types'}},
                           {'educationalalignment':{'gsystem_names_list':['Quiz','QuizItem','Topic','File','Page','NUSSD Course'],
                                                    'data_type':'basestring',
                                                    'meta_type':'factory_types'}},
                           {'curricular':{'gsystem_names_list':['File','Page'],
                                         'data_type':'bool',
                                         'meta_type':'factory_types'}},
...
factory_relation_types = [{'has_shelf':{'subject_type':['Author'],
                                        ...
                                        'meta_type':'factory_types'}}, 
                          {'translation_of':{'subject_type':['Page'],
                                             'object_type':['Page'], 
                          ...
                          {'has_profile_pic':{'subject_type':['Author'],
                                              ...
                                              'meta_type':'factory_types'}}, 
                          {'has_course':{'subject_type':['Batch'],
                                         'object_type':['NUSSD Course'], 
                                         'inverse_name':'course_of', 
                                         'meta_type':'factory_types'}}, 
                          {'has_batch_member':{'subject_type':['Batch'],
                                               'object_type':['NUSSD Course'], 
                                               'inverse_name':'batch_member_of', 
                                               'meta_type':'factory_types'}}, 
                          {'has_thread':{'subject_type':['Page', 'File'],
                                         'object_type':['Twist'], 
                                         'inverse_name':'thread_of', 
                                         'meta_type':'factory_types'}}, 
                          {'teaches':{'subject_type':['Page','File'],
                                      'object_type':['Page','Concept','Topic'], 

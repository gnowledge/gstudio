      ...
      for colg_ids in colg_list_cur: 
        ...
        for each in unset_ac_options:
          ...
          if course_gst.name == u"Announced Course":
            ...
            c_name = unicode(course_node.attribute_set[1][u'course_code'] + "_" + colg_ids.attribute_set[0][u"enrollment_code"]+"_" + start_time.strftime("%b-%Y") + "_" + end_time.strftime("%b-%Y"))

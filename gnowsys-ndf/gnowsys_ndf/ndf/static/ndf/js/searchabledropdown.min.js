...
(function($){
	...
	function draw(){
		...
		// m.height(50);
		m.css({"height":40,"width":500});
		q.css("position","relative");
		q.css("width",500);
		// q.css("height",10);
		// q.css("width",m.outerWidth());
		if($.browser.msie)q.css("z-index",h);
		r.css({"position":"absolute","top":0,"left":0,"width":500,"height":40,"background-color":"#FFFFFF","opacity":"0.01"});

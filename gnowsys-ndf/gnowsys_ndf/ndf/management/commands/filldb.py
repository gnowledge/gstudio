...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        o_gt.name = unicode("Wikipage")
        o_gt.member_of.append(unicode("GSystemType"))
        o_gt.save()
        ...
        if not hm.create_or_replace_json_file(o_gt):
            ...
            rcsobj.checkin(fp, 1, "This document("+str(o_gt.name)+") is of GSystemType.", "-i")
        ...
        o_gs.member_of.append(unicode("Wikipage"))
        ...
        if not hm.create_or_replace_json_file(o_gs):
            ...
            rcsobj.checkin(fp, 1, "This document("+str(o_gs.name)+") is of GSystem.", "-i")

...
from gnowsys_ndf.settings import GAPPS as setting_gapps, DEFAULT_GAPPS_LIST, META_TYPE, CREATE_GROUP_VISIBILITY, GSTUDIO_SITE_DEFAULT_LANGUAGE, GSTUDIO_SITE_EDITOR
...
@register.assignment_tag
def gstudio_site_editor():
   return GSTUDIO_SITE_EDITOR

...
urlpatterns = patterns('gnowsys_ndf.ndf.views.gcourse',
                        ...
                        # url(r'^/session-id/sub-session-id/unit-id/$', 'course_resource_detail', name='course_resource_detail'),
                        # url(r'^/(?P<course_section>)/(?P<course_sub_section>)/(?P<course_unit>)/(?P<resource_id>)/$', 'course_resource_detail', name='course_resource_detail'),

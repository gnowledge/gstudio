...
urlpatterns = patterns('',
    ...
    url(r'^(?P<group_id>[^/]+)/meeting','gnowsys_ndf.ndf.views.meeting.dashb', name='meeting'),
    url(r'^about.html/','gnowsys_ndf.ndf.views.home.site_about',name='site_about'),    
    url(r'^credits.html/','gnowsys_ndf.ndf.views.home.site_credits',name='site_credits'),    
    url(r'^contact.html/','gnowsys_ndf.ndf.views.home.site_contact',name='site_contact'),    
    url(r'^termsofuse.html/','gnowsys_ndf.ndf.views.home.site_termsofuse',name='site_termsofuse'),    
    url(r'^privacypolicy.html/','gnowsys_ndf.ndf.views.home.site_privacypolicy',name='site_privacypolicy'),    
    # --end meeting app
